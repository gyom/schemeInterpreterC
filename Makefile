...
test_SchemeObject : SchemeObject.c SchemeObject.h MemorySpace.c MemorySpace.h GarbageCollection.c SchemeObject_tests.c SchemeObject_tests.h atomic_functions.c sn1t_parsing.c
	gcc -g -D TEST_SCHEMEOBJECT_ALONE -D DEBUG_MEMORYSPACE -D DEBUG_SN1T -Wall MemorySpace.c GarbageCollection.c SchemeObject_tests.c atomic_functions.c sn1t_parsing.c SchemeObject.c -o test_SchemeObject
...
test_SchemeObject_debug_execute : SchemeObject.c SchemeObject.h MemorySpace.c MemorySpace.h GarbageCollection.c SchemeObject_tests.c SchemeObject_tests.h atomic_functions.c sn1t_parsing.c
	gcc -g -D TEST_SCHEMEOBJECT_ALONE -D DEBUG_EXECUTE -D DEBUG_MEMORYSPACE -D DEBUG_SN1T -Wall MemorySpace.c GarbageCollection.c SchemeObject_tests.c atomic_functions.c sn1t_parsing.c SchemeObject.c -o test_SchemeObject
